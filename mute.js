module.exports.run = async (bot, message, args) => {
    if (!message.member.hasPermission("MANAGE_ROLES")) return message.channel.send('Недостаточно прав для использования данной команды!')
    ...
    await message.channel.send(`<@${message.author.id}> поставил заглушение <@${member.id}>\n**Причина**: ${reason}`)
}
